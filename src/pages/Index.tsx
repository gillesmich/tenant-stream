...
import { Home, Users, FileText, Euro, Plus, TrendingUp, TrendingDown, AlertTriangle } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Bienvenue dans votre espace de gestion locative
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="shadow-card hover:shadow-elegant transition-all duration-300">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-500">{stats.paidRents}</div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card className="shadow-card hover:shadow-elegant transition-all duration-300">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-500">{stats.overdueRents}</div>
              <p className="text-xs text-muted-foreground">
                À traiter
              </p>
            </CardContent>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg opacity-50">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-medium">Générez les loyers</h4>
                      <p className="text-sm text-muted-foreground">Automatisez le suivi des paiements</p>
                    </div>
                  </div>
                  <Button size="sm" variant="outline" disabled>
                    Bientôt
